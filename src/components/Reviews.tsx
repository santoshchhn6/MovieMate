...
const Reviews = () => {
  ...
  const reviews = useSelector((state: RootState) => state.movieDetail.reviews);
    ...
    <>
      ...
      {reviews.length ? (
        !showAllReviews ? (
          ...
          <div className=" w-[60%] h-[80%] fixed z-50 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]   bg-gray-900 rounded-lg overflow-hidden">
